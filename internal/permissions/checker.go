...
func (c *Checker) Check(userID, toolName string, input json.RawMessage) (allowed bool, reason string) {
...
func (c *Checker) checkOrgPolicies(userID, toolName string) (allowed bool, reason string) {
...
func (c *Checker) checkRBAC(userID, toolName string) (allowed bool, reason string) {
