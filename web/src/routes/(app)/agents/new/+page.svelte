...
<div class="cr">
	<div class="cr__main">
		<div class="cr__top">
			...
			<div>
				<h1 class="cr__title">New Agent</h1>
				<p class="cr__sub">Configure an AI agent with custom instructions and capabilities.</p>
			</div>
		</div>
		...
		<form class="cr__form" onsubmit={handleSubmit}>
			...
			<button type="submit" class="cr__submit" disabled={loading || !name.trim()}>
				{#if loading}
					<span class="cr__spinner"></span> Creating...
				{:else}
					Create Agent
				{/if}
			</button>
